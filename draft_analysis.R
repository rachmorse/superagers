...
long_data <- data %>%
  pivot_longer(
    cols = matches("^age\\_\\d$|^memory\\_\\d$|^sfc_all\\_\\d$|^struct_within_Default\\_\\d$|^func_within_DorsalAttention\\_\\d$|^func_between_Default\\_\\d$|^sfc_Default\\_\\d$|^sfc_Frontoparietal\\_\\d$|^func_within_Frontoparietal\\_\\d$|^func_within_Visual\\_\\d$"),
