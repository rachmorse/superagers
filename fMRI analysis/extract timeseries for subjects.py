import os
import pandas as pd
from TimeseriesExtractor import TimeseriesExtractor  # Import the class from the timeseries_extractor.py file
...
def main(multi=False):
    ...
    """
    ses = "01"
    th = "05"  # Threshold for FWD that was used for scrubbing.
    root = "/home/rachel/Desktop/fMRI Analysis/Scrubbed data"
    output_dir = "/home/rachel/Desktop/fMRI Analysis/DK76"
